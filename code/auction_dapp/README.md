...
Anyone can bid on an auction except the owner of the auction. Biding means that previous bidders are refunded, and a new bid is placed. Bid requirements are as follows:
